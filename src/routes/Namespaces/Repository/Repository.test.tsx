...
test('Org and repo names should show in Title and Breadcrumb', () => {
    ...
    mocked(useSearchParams, true).mockImplementation(() => [new URLSearchParams(), jest.fn()]);
    render(<RecoilRoot><Repository /></RecoilRoot>);
    expect(screen.getByTestId("namespace-breadcrumb")).toHaveTextContent("namespaces");
